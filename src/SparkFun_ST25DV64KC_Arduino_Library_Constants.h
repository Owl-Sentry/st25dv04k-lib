...
#define BIT_GPO1_RF_USER_EN (1 << 0)
#define BIT_GPO1_RF_ACTIVITY_EN (1 << 1)
#define BIT_GPO1_RF_INTERRUPT_EN (1 << 2)
#define BIT_GPO1_FIELD_CHANGE_EN (1 << 3)
#define BIT_GPO1_RF_PUT_MSG_EN (1 << 4)
#define BIT_GPO1_RF_GET_MSG_EN (1 << 5)
#define BIT_GPO1_RF_WRITE_EN (1 << 6)
#define BIT_GPO1_GPO_EN (1 << 7)
